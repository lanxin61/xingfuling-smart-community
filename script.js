const services = [
  ...
  },
  {
    ...
    items: [
      {
        name: "家庭健康档案",
        desc: "为长者建立个人基础信息、既往病史、用药情况、体检记录和服务记录，形成家庭和社区都能理解的健康资料库。"
      },
      {
        name: "慢病跟踪",
  ...
  },
  {
    id: "culture-club",
    title: "银龄文社",
    label: "Silver Culture",
    summary: "通过国学、美食养生、非遗手工、书画雅艺和文体活动，丰富长者精神文化生活。",
    scenario: "适用于希望参与社区学习、兴趣社交、文化活动和自我价值实现的中老年群体。",
    image: "assets/culture-club-detail.png",
    intro: "银龄文社以精神文化养老为核心，为长者提供持续参与、持续学习和持续社交的社区文化空间。通过国学、美食养生、非遗手作、书画文艺和生活兴趣课程，帮助长者从被照护者转变为社区文化参与者和创造者。",
    values: [
      "丰富长者精神文化生活，减少孤独感。",
      "搭建社区熟人社交场景，增强归属感。",
      "让长者通过作品、活动和课程实现自我价值。",
  ...
  },
  {
    ...
    summary: "为长者家庭提供正规养老机构、护理中心和康养中心的筛选、对接、评估和入住支持。",
    scenario: "适用于高龄、失能、半失能、独居、无人照料或需要专业机构照护的老人及其家庭。",
    image: "assets/institution-selection-detail.png",
    intro: "康养机构甄选服务面向有机构入住、康复托养或长期照护需求的老人家庭，依托社区信任和合作机构资源，帮助家庭完成机构筛选、资质核验、预算匹配、考察陪同和入住衔接，减少信息不透明带来的选择压力。",
    values: [
      "帮助家庭降低筛选养老机构的信息成本。",
      "通过社区可信入口提升机构对接安全感。",
